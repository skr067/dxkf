package com.kqkj.ct.consumer.dao;
...
import com.kqkj.ct.consumer.bean.Calllog;
...
public class HBaseDao extends BaseDao {
    ...
    public void init() throws Exception{
        ...
        createTableXX(Names.TABLE.getValue(),"com.kqkj.ct.consumer.coprocessor.InsertCalleeCoprocessor",ValueConstant.REGION_COUNT,Names.CF_CALLER.getValue(),
    ...
    public void insertData(Calllog log) throws Exception{
        log.setRowskey(genRegionNum(log.getCall1(),log.getCalltime()) + "_" + log.getCall1() + "_" + log.getCalltime() + "_" + log.getCall2() + "_" + log.getDuration());
    ...
    public void insertData(String value) throws Exception{
        ...
        /**
         * rowkey设计
         * 1）长度原则：最大值64KB，推荐长度为10~100byte
         *            最好8的倍数，能短则短，rowkey如果太长会影响性能
         * 2）唯一原则：rowkey应该具备唯一性
         * 3）散列原则：盐值散列：不能使用时间戳直接作为rowkey,在rowskey前增加随机数
         *            字符串反转：电话号码
         *            计算分区号：hashMap
         * rowskey = regionNum + call1 + time + call2 + duration
         */
